...
from app.api.auth_context import AuthContextMiddleware
app.add_middleware(AuthContextMiddleware)

# 2. Rate Limit Middleware
from app.api.rate_limit_guard import RateLimitMiddleware
...
# --- Routers ---
from app.api import graph_api, card_docs_api, rag_api, docs_status_api, tree_api, download_api
